...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/05/11 17:19:39 by mvachera          #+#    #+#              #
#    Updated: 2023/05/11 17:21:25 by mvachera         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS	= ft_lstadd_back.c ft_lstlast.c ft_lstnew.c ft_lstadd_front.c ft_lstsize.c ft_lstclear.c ft_lstdelone.c ft_lstiter.c ft_lstmap.c
